...
public class ModArmorMaterials {
    ...
    public static ResourceKey<EquipmentAsset> TOPAZ = ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(Topazium.MODID, "topaz"));
    public static ResourceKey<EquipmentAsset> BLUE_TOPAZ = ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(Topazium.MODID, "blue_topaz"));
