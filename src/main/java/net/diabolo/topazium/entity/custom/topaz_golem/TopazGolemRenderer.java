    ...
    private static final Map<TopazGolemVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TopazGolemVariant.class), map -> {
                map.put(TopazGolemVariant.BASIC_BASIC,
                        Identifier.fromNamespaceAndPath(Topazium.MODID, "textures/entity/topaz_golem/topaz_golem.png"));
                map.put(TopazGolemVariant.BLASTER_BASIC,
                        Identifier.fromNamespaceAndPath(Topazium.MODID, "textures/entity/topaz_golem/topaz_golem_blaster.png"));
                map.put(TopazGolemVariant.MINER_BASIC,
                        Identifier.fromNamespaceAndPath(Topazium.MODID, "textures/entity/topaz_golem/topaz_golem_miner.png"));
