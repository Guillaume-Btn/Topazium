package net.diabolo.topazium.block;


import net.diabolo.topazium.Topazium;
import net.diabolo.topazium.block.custom.ComponentTableBlock;
import net.diabolo.topazium.block.custom.CrystalInfuserBlock;
import net.diabolo.topazium.block.custom.GolemMakerControllerBlock;
import net.diabolo.topazium.block.custom.GolemMakerPartBlock;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(Topazium.MODID);
