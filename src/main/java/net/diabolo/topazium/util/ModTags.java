package net.diabolo.topazium.util;
...
public class ModTags {
    public static class Blocks{
        ...
        private static TagKey<Block> createTag(String name){
            return BlockTags.create(Identifier.fromNamespaceAndPath(Topazium.MODID,name));
        }
    }
    ...
    public static class Items{
        ...
        private static TagKey<Item> createTag(String name){
            return ItemTags.create(Identifier.fromNamespaceAndPath(Topazium.MODID,name));
        }
    }
}