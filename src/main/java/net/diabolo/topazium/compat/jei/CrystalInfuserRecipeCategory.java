...
public class CrystalInfuserRecipeCategory implements IRecipeCategory<CrystalInfuserRecipe> {
    public static final Identifier UID = Identifier.fromNamespaceAndPath(Topazium.MODID, "crystal_infuser");
    public static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Topazium.MODID, "textures/gui/crystal_infuser/crystal_infuser_gui.png");
    ...
    public @NonNull Component getTitle() {
        return Component.translatable("block.topazium.crystal_infuser");
    }
